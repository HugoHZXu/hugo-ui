...
describe('Input', () => {
  it('forwards native props', () => {
    render(<Input aria-label="Item name" placeholder="@hugo-ui/shadcn" />);
  ...
  it('uses label text as placeholder for search inputs', () => {
    render(<Input label="Search items" name="search" />);

    const input = screen.getByPlaceholderText('Search items');
    expect(input).toBeInTheDocument();
    expect(screen.queryByText('Search items')).not.toBeInTheDocument();
  });
